...
## Recursos
- **WORM**: bucket S3 com Object Lock (COMPLIANCE), retenção mínima configurável (default 365 dias), versioning, SSE-KMS dedicado e bloqueio de acesso público.
...
- Object Lock + retenção >=365 dias, versionamento e SSE-KMS no bucket WORM;
