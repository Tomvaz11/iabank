...
- **WORM**: bucket com Object Lock ativo, role (`SEEDS_WORM_ROLE_ARN`) e KMS (`SEEDS_WORM_KMS_KEY_ID`) configurados. Retencao minima `SEEDS_WORM_RETENTION_DAYS >= 1855` (30 dias + 5 anos).
