...
- **Preflight**: Checar migrations pendentes; validar enforcement de RLS (Art. XIII), flags/canary do domínio e disponibilidade do Vault/WORM (bucket, role/KMS, retenção, chave FPE ativa no Vault); abortar fail-closed se qualquer pré-condição falhar, retornando Problem Details e sem enfileirar lotes.  
