...
- Q: Cobertura de estados nas seeds/factories (apenas feliz vs principais estados)? → A: Cobrir estados principais por entidade (ativo/bloqueado/inadimplente/cancelado) com proporções definidas no manifesto por tenant/mode, evitando inflar volumetria fora do perfil.
